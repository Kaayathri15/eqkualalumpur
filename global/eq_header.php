...
<head>
    ...
    <style>
        header {
            ...
            /* NEW: Hide header by default */
            opacity: 0;
            visibility: hidden;
            transform: translateY(-100%);
            /* Slide it up out of view */
        }
...
<body>
 ...
 <div class="intro-logo" id="mainLogo">
    <img width="200px" src="https://www.equatorial.com/wp-content/themes/eqgroup/img/logo.svg" alt="EQ Logo" />
  </div>
            </div>

            <div class="header-center">
                <nav class="nav-links">
                    <a href="javascript:void(0)" id="dest-trigger">Destination</a>
    ...
    <div id="dest-overlay" class="dest-overlay"></div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Close if user clicks outside the inner content
